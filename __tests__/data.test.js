...
describe('Data Helpers', () => {
  ...
  describe('Education Types', () => {
    it('should have 9 education types', () => {
      expect(educationTypes).toHaveLength(9);
    });
    ...
    it('should have first education type as general secondary', () => {
      expect(educationTypes[0].label).toBe('ثانوية عامة');
      expect(educationTypes[0].value).toBe('general_secondary');
    });

    it('should have last education type as graduate', () => {
      expect(educationTypes[8].label).toBe('خريج');
      expect(educationTypes[8].value).toBe('graduate');
    });
